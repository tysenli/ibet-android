...
class GameLobbyTournaments: Fragment() {
    ...
    private  fun fetchGames(){
        val url = BuildConfig.GAME_URL+ "live-casino" + BuildConfig.GAME_URL_CATEGORY + "tournaments"
        ...
        client.newCall(request).enqueue(object: okhttp3.Callback {
            override fun onResponse(call: okhttp3.Call?, response: okhttp3.Response?) {
                ...
                this@GameLobbyTournaments.activity!!.runOnUiThread {
