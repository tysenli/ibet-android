...
class AsiaAliOpenPage: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myweb.loadUrl(intent.getStringExtra("asia_aliurl"))
        ...
        order_number.text = intent.getStringExtra("asia_aliorderId")
        ...
        deposit_check.setOnClickListener {
            ...
            val orderBody = FormBody.Builder()
                .add("order_id", intent.getStringExtra("asia_aliorderId"))
            ...
            if (response.code() != 200) {
                ...
                if (JSONObject(statusData).getString("status") == "001") {
                    ...
                    depositJson.put("balance", intent.getStringExtra("asia_alibalance"))
